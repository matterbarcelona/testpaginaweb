      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <h2 
            ...
            className="text-3xl md:text-5xl font-bold mb-6 text-foreground text-center"
          >
            Material Bank x Matter
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground mb-12 text-center max-w-3xl mx-auto leading-relaxed">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h3 className="text-lg font-semibold mb-2 text-foreground">24 horas</h3>
              <p className="text-muted-foreground text-sm">Muestras en tu estudio al día siguiente</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h3 className="text-lg font-semibold mb-2 text-foreground">Un único envío</h3>
              <p className="text-muted-foreground text-sm">Consolidamos todas tus muestras</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h3 className="text-lg font-semibold mb-2 text-foreground">Menor impacto</h3>
              <p className="text-muted-foreground text-sm">Máxima eficiencia y sostenibilidad</p>
            </div>
          </div>
